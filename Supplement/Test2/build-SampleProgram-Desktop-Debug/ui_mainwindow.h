...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnOn->setGeometry(QRect(100, 90, 113, 91));
        btnOff = new QPushButton(centralWidget);
        btnOff->setObjectName(QStringLiteral("btnOff"));
        btnOff->setGeometry(QRect(280, 90, 113, 91));
        label = new QLabel(centralWidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(110, 60, 271, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "The Best GUI Evar!", 0));
    } // retranslateUi
